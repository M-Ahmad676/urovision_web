  ...
  return (
    ...
    >
      <div className="pt-5 bg-white rounded-t-lg overflow-hidden">
        <div className="flex items-center gap-x-2 px-5 text-blue-500">
        ...
        <ul className="flex justify-center mt-10 font-medium text-gray-400 min-h-[2rem] text-[0.8rem] sm:text-[0.9rem]">
          ...
          <li className={`cursor-pointer px-10  hover:text-black ${ tab === 1 ? "border-b-2 border-blue-600" : "hover:border-b-2 border-blue-600"}`} onClick={() => handleTabs(1)}>
            All
          </li>
          <li className={`cursor-pointer px-5 hover:text-black ${ tab === 2 ? "border-b-2 border-blue-600" : "hover:border-b-2 border-blue-600"}`} onClick={() => handleTabs(2)}>
            Important
          </li>
          <li className={`cursor-pointer px-10  hover:text-black ${ tab === 3 ? "border-b-2 border-blue-600" : "hover:border-b-2 border-blue-600"}`} onClick={() => handleTabs(3)}>
            Unread
          </li>
        </ul>
      </div>
      ...
      {All.map((notification, index) => (
        ...
        >
          <div className="flex gap-x-3">
            <FaUserCircle className="text-[2.5rem] text-blue-200 flex-shrink-0" />
