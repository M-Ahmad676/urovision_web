      ...
      <div className="ml-0 md:ml-[15rem] lg:ml-[17rem] xl:ml-[19rem] px-5">
          ...
          <div className="space-y-3 text-center min-[525px]:text-start">
            ...
            <div className="flex py-5">
              <div className="border-r text-center border-gray-300 px-7">
                ...
                <p className="pt-3 text-base sm:text-[1.3rem] font-semibold">Male</p>
              </div>

              <div className="border-r text-center border-gray-300 px-10">
                <p className="text-sm ">Age</p>
                <p className="pt-3 text-base sm:text-[1.3rem] font-semibold">22</p>
              </div>

              <div className="border-r text-center border-gray-300 px-10">
                <p className="text-sm ">Weight</p>
                <p className="pt-3 text-base sm:text-[1.3rem] font-semibold">65kg</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="py-10 flex flex-wrap lg:flex-nowrap gap-y-10 justify-between lg:gap-x-20 ">
          ...
          <div className="border-b border-gray-300">
            ...
            <div className="py-10">
              <div className="text-blue-400 flex gap-x-10 items-center p-5">
                <h1 className="w-32">10 Jan 2024</h1>
                <div className="border-b-2 border-blue-400 w-full"></div>
              </div>
              <div className="px-6 space-y-3">
                ...
                <p className="text-gray-400">Dr. Anayatullah kazmi</p>
                </div>
              </div>
              </div>
            </div>
          ...
          <div className="max-w-[100%] lg:max-w-[50%] w-full">
            ...
            <div className="flex justify-between items-center shadow-sm shadow-gray-300 rounded-lg p-4 my-4 bg-white cursor-pointer hover:bg-slate-100" onClick={handleMedicalRecord}>
